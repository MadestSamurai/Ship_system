...
public class CommonService {
    ...
    public static String upd_message_department_null_error="更新失败，提交部门信息为空";
    public static String upd_message_part_null_error="更新失败，提交部件信息为空";
    ...
    public static String add_message_department_null_error="添加失败，提交部门信息为空";
}
